    ...
    <div className="add-right">
      <div className="category">
        ...
        <div>
          ...
          {/* <div
            ...
            onClick={() => setMainCategory(!mainCategory)}
          >
            ...
            {mainCategory && (
              <ul>
                <li onClick={() => handleMainCategory("وصلنا حديثا")}>
                  وصلنا حديثا{" "}
                </li>
                ...
                <li onClick={() => handleMainCategory("اكسسوارات")}>
                  اكسسوارات
                </li>
                <li onClick={() => handleMainCategory("ركن الجمال")}>
                  ركن الجمال
                </li>
              </ul>
            )}
      ...
      <div className="status">
        <div className="stat d-flex justify-content-between">
          ...
          <span
            className={
              statusSelected == "Published"
                ? "pub"
                : statusSelected == "Draft"
                ? "draft"
                : statusSelected == "Low Stock"
                ? "low"
                : "out"
            }
          >
          ...
          >
            ...
            {status && (
              <ul>
                ...
                <li onClick={() => handleStatus("Out of Stock")}>
                  Out of Stock
                </li>
              </ul>
            )}
