    ...
    <div className="pricing my-3">
      ...
      <div className="d-flex align-items-end">
        <div className="d-flex flex-column flex-grow-1 ">
          <p>Discount Type</p>
          <div
            className="dis-type half px-3 d-flex align-items-center justify-content-between me-3"
            onClick={() => setShowDiscountType(!showDiscountType)}
          >
            <p className="m-0">{discountType}</p>
            <div className="fs-4 mt-0">
      ...
      <div className="d-flex align-items-end">
        <div className="d-flex flex-column flex-grow-1 ">
          ...
          <div
            className="dis-type half px-3 d-flex align-items-center justify-content-between me-3"
            onClick={() => setShowTaxClass(!showTexCalss)}
          >
