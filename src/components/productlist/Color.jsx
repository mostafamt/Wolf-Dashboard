          ...
          <div className='d-flex align-items-end' >
            <div className='d-flex flex-column flex-grow-1 '>
              ...
              <div className='dis-type half px-3 d-flex align-items-center justify-content-between me-3'>
                <p className='m-0 flex-grow-1' onClick={() => setShowColor(!showColor)}>{Color}</p>
                <div className='fs-4 mt-0' onClick={() => setColor(!showColor)}><MdOutlineKeyboardArrowDown /></div>
                {showColor &&
                  <ul>
            ...
            <div className='cancel ms-3' onClick={removeColor}><BsXLg /></div>
          </div>
        </>
        )
      })}
