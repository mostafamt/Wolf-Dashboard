          ...
          <div className='d-flex align-items-end' >
            <div className='d-flex flex-column flex-grow-1 '>
              ...
              <div className='dis-type half px-3 d-flex align-items-center justify-content-between me-3'>
                <p className='m-0 flex-grow-1' onClick={() => setShowsize(!showsize)}>{size}</p>
                <div className='fs-4 mt-0' onClick={() => setShowsize(!showsize)}><MdOutlineKeyboardArrowDown /></div>
                {showsize &&
                  <ul>
                    <p className='shoes' onClick={() => handleShoes()}>Shoes</p>
                    {showShoes && <>
                      <li onClick={() => handleSize('value')}>bala bla</li>
                      <li onClick={() => handleSize('value')}>bala bla</li>
                    </>}
                    <p className='cloths' onClick={() => handleClothes()}>Clothes</p>
                    {showCloths && <>
                      <li onClick={() => handleSize('value')}>bala bla</li>
                      <li onClick={() => handleSize('value')}>bala bla</li>
                    </>}
            ...
            <div className='cancel ms-3' onClick={removeSize}><BsXLg /></div>
          </div>
        </>
        )
      })}
